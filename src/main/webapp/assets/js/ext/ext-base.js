					...
					isIE=!isOpera&&ua.indexOf("msie")>-1,
						isIE7=!isOpera&&ua.indexOf("msie 7")>-1,
							isGecko=!isSafari&&ua.indexOf("gecko")>-1,
								...
								isAir=(ua.indexOf("adobeair")!=-1),isLinux=(ua.indexOf("linux")!=-1),
							...
							Ext.apply(Ext,{
								isStrict:isStrict,isSecure:isSecure,isReady:false,enableGarbageCollector:true,
								enableListenerCollection:false,SSL_SECURE_URL:"javascript:false",
													...
													extend:function(){
														var io=function(o){
															...
															return function(sb,sp,overrides){
																...
																F.prototype=spp;sbp=sb.prototype=new F();
																sbp.constructor=sb;
																sb.superclass=spp;if(spp.constructor==oc){
																	spp.constructor=sp
																	}
																							...
																							if(typeof cb=="function"){
																								if(delay){
																									cb.defer(delay,scope,args||[])
																										...
																										cb.apply(scope,args||[])}}},getDom:function(el){
																											if(!el||!document){
																												return null
																												}
																																	...
																																	for(var i=0,a=arguments,len=a.length;i<len;i++){
																																		...
																																		var d;return function(n){
																																			...
																																			if(n&&n.parentNode&&n.tagName!="BODY"){
																																				...
																																				var t=typeof o;if(t=="object"&&o.nodeName){
																																					switch(o.nodeType){
																																										...
																																										var D=this;return function(){
																																											...
																																											if(A===true){
																																												...
																																												F=F.concat(B)
																																													...
																																													if(typeof A=="number"){
																																														F=Array.prototype.slice.call(arguments,0);
																																														var E=[A,0].concat(B);Array.prototype.splice.apply(F,E)
																																														}
																																													}
																																								...
																																								Ext.applyIf(String,{
																																									escape:function(A){
																																										return A.replace(/('|\\)/g,"\\$1")
																																											...
																																											var A=new String(D);if(!C){
																																												C=" "
																																													}while(A.length<B){
																																													A=C+A}return A.toString()
																																													},format:function(B){
